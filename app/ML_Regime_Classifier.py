...
def main():
    ...
    st.info("Model predicts whether the next bar's return will be positive (Up/Down regime).")
    ...
    if st.button("Train Model"):
        ...
        # ML-based strategy: long when ML_Regime_Up is True
        ...
        fig = equity_curve_plot(
            equity_ml,
            title=f"{symbol} – ML Regime Strategy Equity"
        )
